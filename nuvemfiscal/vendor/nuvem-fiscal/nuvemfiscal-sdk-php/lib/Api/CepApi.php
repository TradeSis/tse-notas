...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['consultarCep'] to see the possible values for this operation
     *
     * @throws \NuvemFiscal\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NuvemFiscal\Model\CepEndereco
     */
    public function consultarCep($cep, string $contentType = self::contentTypes['consultarCep'][0])
    {
        list($response) = $this->consultarCepWithHttpInfo($cep, $contentType);
        return $response;
    }
     ...
     */
    public function consultarCepWithHttpInfo($cep, string $contentType = self::contentTypes['consultarCep'][0])
    {
        $request = $this->consultarCepRequest($cep, $contentType);
     ...
     */
    public function consultarCepAsync($cep, string $contentType = self::contentTypes['consultarCep'][0])
    {
        return $this->consultarCepAsyncWithHttpInfo($cep, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function consultarCepAsyncWithHttpInfo($cep, string $contentType = self::contentTypes['consultarCep'][0])
    {
        $returnType = '\NuvemFiscal\Model\CepEndereco';
        $request = $this->consultarCepRequest($cep, $contentType);
     ...
     */
    public function consultarCepRequest($cep, string $contentType = self::contentTypes['consultarCep'][0])
    {
