 ...
 */
class NfeSefazICMSSN900 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfeSefazICMSSN900';
    ...
    protected static $setters = [
        ...
        'p_fcpst' => 'setPFcpst',
        'v_fcpst' => 'setVFcpst',
        'p_cred_sn' => 'setPCredSn',
        'v_cred_icmssn' => 'setVCredIcmssn'
    ];
    ...
    protected static $getters = [
        ...
        'p_fcpst' => 'getPFcpst',
        'v_fcpst' => 'getVFcpst',
        'p_cred_sn' => 'getPCredSn',
        'v_cred_icmssn' => 'getVCredIcmssn'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('p_cred_sn', $data ?? [], null);
        $this->setIfExists('v_cred_icmssn', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets csosn
     *
     * @param string $csosn Tributação pelo ICMS 900 - Outros(v2.0).
     *
     * @return self
     */
     ...
     * Sets mod_bcst
     *
     * @param int|null $mod_bcst Modalidade de determinação da BC do ICMS ST:  * 0 - Preço tabelado ou máximo  sugerido  * 1 - Lista Negativa (valor)  * 2 - Lista Positiva (valor)  * 3 - Lista Neutra (valor)  * 4 - Margem Valor Agregado (%%)  * 5 - Pauta (valor)  * 6 - Valor da Operação
     *
     * @return self
     */
     ...
     * Sets v_bcst
     *
     * @param float|null $v_bcst Valor da BC do ICMS ST.
     *
     * @return self
     */
     ...
     * Sets p_icmsst
     *
     * @param float|null $p_icmsst Alíquota do ICMS ST.
     *
     * @return self
     */
     ...
     * Sets v_icmsst
     *
     * @param float|null $v_icmsst Valor do ICMS ST.
     *
     * @return self
     */
    ...
    {
        return $this->container['p_cred_sn'];
    }

    /**
     * Sets p_cred_sn
     *
     * @param float|null $p_cred_sn Alíquota aplicável de cálculo do crédito (Simples Nacional). (v2.0).
     *
     * @return self
     */
    ...
    {
        return $this->container['v_cred_icmssn'];
    }

    /**
     * Sets v_cred_icmssn
     *
     * @param float|null $v_cred_icmssn Valor crédito do ICMS que pode ser aproveitado nos termos do art. 23 da LC 123 (Simples Nacional) (v2.0).
     *
     * @return self
     */
