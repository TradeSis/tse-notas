 ...
 */
class NfeSefazFat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfeSefazFat';
    ...
    */
    ...
    public function setNFat($n_fat)
    {
        ...
        if (!is_null($n_fat) && (mb_strlen($n_fat) > 60)) {
            throw new \InvalidArgumentException('invalid length for $n_fat when calling NfeSefazFat., must be smaller than or equal to 60.');
        }
        if (!is_null($n_fat) && (mb_strlen($n_fat) < 1)) {
            throw new \InvalidArgumentException('invalid length for $n_fat when calling NfeSefazFat., must be bigger than or equal to 1.');
        }
