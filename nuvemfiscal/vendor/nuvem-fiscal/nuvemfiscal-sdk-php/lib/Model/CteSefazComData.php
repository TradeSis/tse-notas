 ...
 */
class CteSefazComData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSefazComData';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('d_prog', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['d_prog'] === null) {
            $invalidProperties[] = "'d_prog' can't be null";
        }
     ...
     * @return \DateTime
     */
    public function getDProg()
    {
        return $this->container['d_prog'];
    }

    /**
     * Sets d_prog
     *
     * @param \DateTime $d_prog Data programada.  Formato AAAA-MM-DD.
     *
     * @return self
     */
