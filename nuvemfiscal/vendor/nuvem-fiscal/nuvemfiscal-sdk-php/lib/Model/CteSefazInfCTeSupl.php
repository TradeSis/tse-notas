...
/**
 * CteSefazInfCTeSupl Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSefazInfCTeSupl implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSefazInfCTeSupl';
    ...
    {
        $this->setIfExists('qr_cod_cte', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getQrCodCte()
    {
        return $this->container['qr_cod_cte'];
    }
