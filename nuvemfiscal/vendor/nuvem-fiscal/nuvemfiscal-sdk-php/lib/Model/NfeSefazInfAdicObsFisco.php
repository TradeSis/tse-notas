...
/**
 * NfeSefazInfAdicObsFisco Class Doc Comment
 *
 * @category Class
 * @description Campo de uso exclusivo do Fisco  informar o nome do campo no atributo xCampo  e o conteúdo do campo no xTexto.
 * @package  NuvemFiscal
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NfeSefazInfAdicObsFisco implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfeSefazInfAdic_ObsFisco';
    ...
    */
     ...
     * Sets x_campo
     *
     * @param string|null $x_campo x_campo
     *
     * @return self
     */
    public function setXCampo($x_campo)
    {
        ...
        if (!is_null($x_campo) && (mb_strlen($x_campo) > 20)) {
            throw new \InvalidArgumentException('invalid length for $x_campo when calling NfeSefazInfAdicObsFisco., must be smaller than or equal to 20.');
        }
        if (!is_null($x_campo) && (mb_strlen($x_campo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_campo when calling NfeSefazInfAdicObsFisco., must be bigger than or equal to 1.');
        }
     ...
     * Sets x_texto
     *
     * @param string|null $x_texto x_texto
     *
     * @return self
     */
    public function setXTexto($x_texto)
    {
        ...
        if (!is_null($x_texto) && (mb_strlen($x_texto) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_texto when calling NfeSefazInfAdicObsFisco., must be smaller than or equal to 60.');
        }
        if (!is_null($x_texto) && (mb_strlen($x_texto) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_texto when calling NfeSefazInfAdicObsFisco., must be bigger than or equal to 1.');
        }
