 ...
 */
class MdfeSefazInfMDFeTranspPeri implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MdfeSefazInfMDFeTransp_Peri';
    ...
    */
    ...
    public function setXNomeAe($x_nome_ae)
    {
        ...
        if (!is_null($x_nome_ae) && (mb_strlen($x_nome_ae) > 150)) {
            throw new \InvalidArgumentException('invalid length for $x_nome_ae when calling MdfeSefazInfMDFeTranspPeri., must be smaller than or equal to 150.');
        }
        if (!is_null($x_nome_ae) && (mb_strlen($x_nome_ae) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_nome_ae when calling MdfeSefazInfMDFeTranspPeri., must be bigger than or equal to 1.');
        }
    ...
    public function setXClaRisco($x_cla_risco)
    {
        ...
        if (!is_null($x_cla_risco) && (mb_strlen($x_cla_risco) > 40)) {
            throw new \InvalidArgumentException('invalid length for $x_cla_risco when calling MdfeSefazInfMDFeTranspPeri., must be smaller than or equal to 40.');
        }
        if (!is_null($x_cla_risco) && (mb_strlen($x_cla_risco) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_cla_risco when calling MdfeSefazInfMDFeTranspPeri., must be bigger than or equal to 1.');
        }
    ...
    public function setGrEmb($gr_emb)
    {
        ...
        if (!is_null($gr_emb) && (mb_strlen($gr_emb) > 6)) {
            throw new \InvalidArgumentException('invalid length for $gr_emb when calling MdfeSefazInfMDFeTranspPeri., must be smaller than or equal to 6.');
        }
        if (!is_null($gr_emb) && (mb_strlen($gr_emb) < 1)) {
            throw new \InvalidArgumentException('invalid length for $gr_emb when calling MdfeSefazInfMDFeTranspPeri., must be bigger than or equal to 1.');
        }
    ...
    public function setQTotProd($q_tot_prod)
    {
        ...
        if (!is_null($q_tot_prod) && (mb_strlen($q_tot_prod) > 20)) {
            throw new \InvalidArgumentException('invalid length for $q_tot_prod when calling MdfeSefazInfMDFeTranspPeri., must be smaller than or equal to 20.');
        }
        if (!is_null($q_tot_prod) && (mb_strlen($q_tot_prod) < 1)) {
            throw new \InvalidArgumentException('invalid length for $q_tot_prod when calling MdfeSefazInfMDFeTranspPeri., must be bigger than or equal to 1.');
        }
    ...
    public function setQVolTipo($q_vol_tipo)
    {
        ...
        if (!is_null($q_vol_tipo) && (mb_strlen($q_vol_tipo) > 60)) {
            throw new \InvalidArgumentException('invalid length for $q_vol_tipo when calling MdfeSefazInfMDFeTranspPeri., must be smaller than or equal to 60.');
        }
        if (!is_null($q_vol_tipo) && (mb_strlen($q_vol_tipo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $q_vol_tipo when calling MdfeSefazInfMDFeTranspPeri., must be bigger than or equal to 1.');
        }
