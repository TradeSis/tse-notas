 ...
 */
class CteSefazOcc implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSefazOcc';
    ...
    protected static $openAPITypes = [
        ...
        'n_occ' => 'int',
        'd_emi' => '\DateTime',
        'emi_occ' => '\NuvemFiscal\Model\CteSefazEmiOcc'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('n_occ', $data ?? [], null);
        $this->setIfExists('d_emi', $data ?? [], null);
        $this->setIfExists('emi_occ', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets serie
     *
     * @param string|null $serie Série da OCC.
     *
     * @return self
     */
    ...
    {
        return $this->container['n_occ'];
    }

    /**
     * Sets n_occ
     *
     * @param int $n_occ Número da Ordem de coleta.
     *
     * @return self
     */
     ...
     * Sets d_emi
     *
     * @param \DateTime $d_emi Data de emissão da ordem de coleta.  Formato AAAA-MM-DD.
     *
     * @return self
     */
     ...
     * Gets emi_occ
     *
     * @return \NuvemFiscal\Model\CteSefazEmiOcc|null
     */
    public function getEmiOcc()
    {
        return $this->container['emi_occ'];
    }

    /**
     * Sets emi_occ
     *
     * @param \NuvemFiscal\Model\CteSefazEmiOcc|null $emi_occ emi_occ
     *
     * @return self
     */
    public function setEmiOcc($emi_occ)
    {
        if (is_null($emi_occ)) {
            throw new \InvalidArgumentException('non-nullable emi_occ cannot be null');
        }
        $this->container['emi_occ'] = $emi_occ;
