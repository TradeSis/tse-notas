...
/**
 * LocacaoSublocacao Class Doc Comment
 *
 * @category Class
 ...
 */
class LocacaoSublocacao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LocacaoSublocacao';
    ...
    {
        $this->setIfExists('categ', $data ?? [], null);
        $this->setIfExists('objeto', $data ?? [], null);
        $this->setIfExists('extensao', $data ?? [], null);
        $this->setIfExists('n_postes', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['categ'] === null) {
            $invalidProperties[] = "'categ' can't be null";
        }
        if ($this->container['objeto'] === null) {
            $invalidProperties[] = "'objeto' can't be null";
        }
     ...
     * Sets categ
     *
     * @param int $categ Categoria do serviço.
     *
     * @return self
     */
     ...
     * Sets objeto
     *
     * @param int $objeto Tipo de objetos da locação, sublocação, arrendamento, direito de passagem ou permissão de uso.
     *
     * @return self
     */
    ...
    {
        return $this->container['extensao'];
    }

    /**
     * Sets extensao
     *
     * @param string $extensao Extensão total da ferrovia, rodovia, cabos, dutos ou condutos.
     *
     * @return self
     */
     ...
     * @return string
     */
    public function getNPostes()
    {
        return $this->container['n_postes'];
    }

    /**
     * Sets n_postes
     *
     * @param string $n_postes Número total de postes.
     *
     * @return self
     */
