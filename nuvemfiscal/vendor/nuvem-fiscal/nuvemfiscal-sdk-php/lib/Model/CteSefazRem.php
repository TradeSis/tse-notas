 ...
 */
class CteSefazRem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSefazRem';
    ...
    protected static $openAPITypes = [
        ...
        'x_fant' => 'string',
        'fone' => 'string',
        'ender_reme' => '\NuvemFiscal\Model\CteSefazEndereco',
        'email' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ender_reme', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ender_reme'] === null) {
            $invalidProperties[] = "'ender_reme' can't be null";
        }
     ...
     * Sets ie
     *
     * @param string|null $ie Inscrição Estadual.  Informar a IE do remetente ou ISENTO se remetente é contribuinte do ICMS isento de inscrição no cadastro de contribuintes do ICMS. Caso o remetente não seja contribuinte do ICMS não informar a tag.
     *
     * @return self
     */
     ...
     * Sets x_nome
     *
     * @param string $x_nome Razão social ou nome do remetente.
     *
     * @return self
     */
    public function setXNome($x_nome)
    {
        ...
        if (!is_null($x_nome) && (mb_strlen($x_nome) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling CteSefazRem., must be smaller than or equal to 60.');
        }
        if (!is_null($x_nome) && (mb_strlen($x_nome) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling CteSefazRem., must be bigger than or equal to 2.');
        }
    ...
    public function setXFant($x_fant)
    {
        ...
        if (!is_null($x_fant) && (mb_strlen($x_fant) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_fant when calling CteSefazRem., must be smaller than or equal to 60.');
        }
        if (!is_null($x_fant) && (mb_strlen($x_fant) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_fant when calling CteSefazRem., must be bigger than or equal to 2.');
        }
     ...
     */
    public function getEnderReme()
    {
        return $this->container['ender_reme'];
    }

    /**
     * Sets ender_reme
     *
     * @param \NuvemFiscal\Model\CteSefazEndereco $ender_reme ender_reme
     *
     * @return self
     */
    public function setEnderReme($ender_reme)
    {
        if (is_null($ender_reme)) {
            throw new \InvalidArgumentException('non-nullable ender_reme cannot be null');
        }
        $this->container['ender_reme'] = $ender_reme;
