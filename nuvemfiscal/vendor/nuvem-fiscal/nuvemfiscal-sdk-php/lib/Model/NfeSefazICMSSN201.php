...
/**
 * NfeSefazICMSSN201 Class Doc Comment
 *
 * @category Class
 ...
 */
class NfeSefazICMSSN201 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfeSefazICMSSN201';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['p_cred_sn'] === null) {
            $invalidProperties[] = "'p_cred_sn' can't be null";
        }
        if ($this->container['v_cred_icmssn'] === null) {
            $invalidProperties[] = "'v_cred_icmssn' can't be null";
        }
     ...
     * Sets csosn
     *
     * @param string $csosn * 201 - Tributada pelo Simples Nacional com permissão de crédito e com cobrança do ICMS por Substituição Tributária (v.2.0)
     *
     * @return self
     */
     ...
     * Sets p_cred_sn
     *
     * @param float $p_cred_sn Alíquota aplicável de cálculo do crédito (Simples Nacional). (v2.0).
     *
     * @return self
     */
     ...
     * Sets v_cred_icmssn
     *
     * @param float $v_cred_icmssn Valor crédito do ICMS que pode ser aproveitado nos termos do art. 23 da LC 123 (Simples Nacional) (v2.0).
     *
     * @return self
     */
