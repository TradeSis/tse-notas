 ...
 */
class CteSefazICMSSN implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSefazICMSSN';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ind_sn', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ind_sn'] === null) {
            $invalidProperties[] = "'ind_sn' can't be null";
        }
     ...
     * @return int
     */
    public function getIndSn()
    {
        return $this->container['ind_sn'];
    }

    /**
     * Sets ind_sn
     *
     * @param int $ind_sn Indica se o contribuinte é Simples Nacional   1=Sim.
     *
     * @return self
     */
