    ...
    */
    ...
    public function setIdUnidCarga($id_unid_carga)
    {
        ...
        if (!is_null($id_unid_carga) && (mb_strlen($id_unid_carga) > 20)) {
            throw new \InvalidArgumentException('invalid length for $id_unid_carga when calling MdfeSefazUnidCarga., must be smaller than or equal to 20.');
        }
        if (!is_null($id_unid_carga) && (mb_strlen($id_unid_carga) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id_unid_carga when calling MdfeSefazUnidCarga., must be bigger than or equal to 1.');
        }
