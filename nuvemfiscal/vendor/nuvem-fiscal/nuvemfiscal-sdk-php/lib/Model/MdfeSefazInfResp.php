 ...
 */
class MdfeSefazInfResp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MdfeSefazInfResp';
    ...
    {
        $this->setIfExists('resp_seg', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['resp_seg'] === null) {
            $invalidProperties[] = "'resp_seg' can't be null";
        }
    ...
    {
        return $this->container['resp_seg'];
    }
     ...
     * Sets cnpj
     *
     * @param string|null $cnpj Número do CNPJ do responsável pelo seguro.  Obrigatório apenas se responsável pelo seguro for (2) responsável pela contratação do transporte - pessoa jurídica.
     *
     * @return self
     */
     ...
     * Sets cpf
     *
     * @param string|null $cpf Número do CPF do responsável pelo seguro.  Obrigatório apenas se responsável pelo seguro for (2) responsável pela contratação do transporte - pessoa física.
     *
     * @return self
     */
