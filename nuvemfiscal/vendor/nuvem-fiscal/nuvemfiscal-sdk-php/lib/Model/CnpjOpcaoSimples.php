 ...
 */
class CnpjOpcaoSimples implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CnpjOpcaoSimples';
    ...
    */
     ...
     * Sets optante
     *
     * @param bool|null $optante Indicador da existência da opção pelo Simples Nacional:  * `true` - É optante.  * `false` - Não é optante.
     *
     * @return self
     */
     ...
     * Sets data_opcao
     *
     * @param \DateTime|null $data_opcao Data da opção pelo Simples Nacional.
     *
     * @return self
     */
     ...
     * Sets data_exclusao
     *
     * @param \DateTime|null $data_exclusao Data da exclusão do Simples Nacional.
     *
     * @return self
     */
