...
/**
 * NfeSefazICMSST Class Doc Comment
 *
 * @category Class
 ...
 */
class NfeSefazICMSST implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfeSefazICMSST';
    ...
    protected static $setters = [
        ...
        'v_bcst_dest' => 'setVBcstDest',
        'v_icmsst_dest' => 'setVIcmsstDest',
    ...
    protected static $getters = [
        ...
        'v_bcst_dest' => 'getVBcstDest',
        'v_icmsst_dest' => 'getVIcmsstDest',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('v_bcst_dest', $data ?? [], null);
        $this->setIfExists('v_icmsst_dest', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['v_bcst_dest'] === null) {
            $invalidProperties[] = "'v_bcst_dest' can't be null";
        }
        if ($this->container['v_icmsst_dest'] === null) {
            $invalidProperties[] = "'v_icmsst_dest' can't be null";
        }
     ...
     * Sets cst
     *
     * @param string $cst Tributção pelo ICMS  * 41 - Não Tributado  * 60 - Cobrado anteriormente por substituição tributária
     *
     * @return self
     */
     ...
     * Sets v_bcst_ret
     *
     * @param float $v_bcst_ret Informar o valor da BC do ICMS ST retido na UF remetente.
     *
     * @return self
     */
     ...
     * Sets v_icmsst_ret
     *
     * @param float $v_icmsst_ret Informar o valor do ICMS ST retido na UF remetente (iv2.0)).
     *
     * @return self
     */
     ...
     * Sets v_bcfcpst_ret
     *
     * @param float|null $v_bcfcpst_ret Informar o valor da Base de Cálculo do FCP retido anteriormente por ST.
     *
     * @return self
     */
     ...
     * Sets p_fcpst_ret
     *
     * @param float|null $p_fcpst_ret Percentual relativo ao Fundo de Combate à Pobreza (FCP) retido por substituição tributária.
     *
     * @return self
     */
     ...
     * Sets v_fcpst_ret
     *
     * @param float|null $v_fcpst_ret Valor do ICMS relativo ao Fundo de Combate à Pobreza (FCP) retido por substituição tributária.
     *
     * @return self
     */
    ...
    {
        return $this->container['v_bcst_dest'];
    }

    /**
     * Sets v_bcst_dest
     *
     * @param float $v_bcst_dest Informar o valor da BC do ICMS ST da UF destino.
     *
     * @return self
     */
    public function setVBcstDest($v_bcst_dest)
    {
        if (is_null($v_bcst_dest)) {
            array_push($this->openAPINullablesSetToNull, 'v_bcst_dest');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('v_bcst_dest', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['v_bcst_dest'] = $v_bcst_dest;
    ...
    {
        return $this->container['v_icmsst_dest'];
    }

    /**
     * Sets v_icmsst_dest
     *
     * @param float $v_icmsst_dest Informar o valor da BC do ICMS ST da UF destino (v2.0).
     *
     * @return self
     */
    public function setVIcmsstDest($v_icmsst_dest)
    {
        if (is_null($v_icmsst_dest)) {
            array_push($this->openAPINullablesSetToNull, 'v_icmsst_dest');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('v_icmsst_dest', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['v_icmsst_dest'] = $v_icmsst_dest;
     ...
     * Sets p_icms_efet
     *
     * @param float|null $p_icms_efet Alíquota do ICMS efetivo.
     *
     * @return self
     */
