...
/**
 * CteSefazInfCteComp Class Doc Comment
 *
 * @category Class
 ...
 */
class CteSefazInfCteComp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSefazInfCteComp';
    ...
    */
     ...
     * Sets ch_cte
     *
     * @param string $ch_cte Chave do CT-e complementado.
     *
     * @return self
     */
    public function setChCte($ch_cte)
    {
        ...
        if (!is_null($ch_cte) && (mb_strlen($ch_cte) > 44)) {
            throw new \InvalidArgumentException('invalid length for $ch_cte when calling CteSefazInfCteComp., must be smaller than or equal to 44.');
        }
