...
/**
 * NfeSefazForDia Class Doc Comment
 *
 * @category Class
 ...
 */
class NfeSefazForDia implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfeSefazForDia';
    ...
    {
        $this->setIfExists('dia', $data ?? [], null);
        $this->setIfExists('qtde', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['dia'];
    }

    /**
     * Sets dia
     *
     * @param int $dia Número do dia.
     *
     * @return self
     */
    ...
    {
        return $this->container['qtde'];
    }

    /**
     * Sets qtde
     *
     * @param float $qtde Quantidade em quilogramas - peso líquido.
     *
     * @return self
     */
