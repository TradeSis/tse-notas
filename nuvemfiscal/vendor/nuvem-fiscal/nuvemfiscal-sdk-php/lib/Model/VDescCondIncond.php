...
/**
 * VDescCondIncond Class Doc Comment
 *
 * @category Class
 ...
 */
class VDescCondIncond implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VDescCondIncond';
    ...
    */
     ...
     * Sets v_desc_incond
     *
     * @param float|null $v_desc_incond Valor monetário do desconto incondicionado (R$).
     *
     * @return self
     */
     ...
     * Sets v_desc_cond
     *
     * @param float|null $v_desc_cond Valor monetário do desconto condicionado (R$).
     *
     * @return self
     */
