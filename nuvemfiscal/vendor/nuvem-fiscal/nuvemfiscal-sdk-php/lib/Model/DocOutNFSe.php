 ...
 */
class DocOutNFSe implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocOutNFSe';
    ...
    protected static $setters = [
        'c_mun_nfse_mun' => 'setCMunNfseMun',
        'n_nfse_mun' => 'setNNfseMun',
        'c_verif_nfse_mun' => 'setCVerifNfseMun'
    ];
    ...
    protected static $getters = [
        'c_mun_nfse_mun' => 'getCMunNfseMun',
        'n_nfse_mun' => 'getNNfseMun',
        'c_verif_nfse_mun' => 'getCVerifNfseMun'
    ];
    ...
    {
        $this->setIfExists('c_mun_nfse_mun', $data ?? [], null);
        $this->setIfExists('n_nfse_mun', $data ?? [], null);
        $this->setIfExists('c_verif_nfse_mun', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['c_mun_nfse_mun'] === null) {
            $invalidProperties[] = "'c_mun_nfse_mun' can't be null";
        }
        if ($this->container['n_nfse_mun'] === null) {
            $invalidProperties[] = "'n_nfse_mun' can't be null";
        }
     ...
     * @return string
     */
    public function getCMunNfseMun()
    {
        return $this->container['c_mun_nfse_mun'];
    }

    /**
     * Sets c_mun_nfse_mun
     *
     * @param string $c_mun_nfse_mun Código Município emissor da nota eletrônica municipal (Tabela do IBGE).
     *
     * @return self
     */
     ...
     * @return int
     */
    public function getNNfseMun()
    {
        return $this->container['n_nfse_mun'];
    }

    /**
     * Sets n_nfse_mun
     *
     * @param int $n_nfse_mun Número da nota eletrônica municipal.
     *
     * @return self
     */
    ...
    /**
     * Gets c_verif_nfse_mun
     *
     * @return string
     */
    public function getCVerifNfseMun()
    {
        return $this->container['c_verif_nfse_mun'];
    }

    /**
     * Sets c_verif_nfse_mun
     *
     * @param string $c_verif_nfse_mun Código de Verificação da nota eletrônica municipal.
     *
     * @return self
     */
