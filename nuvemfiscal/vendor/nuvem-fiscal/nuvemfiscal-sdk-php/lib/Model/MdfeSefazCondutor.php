...
/**
 * MdfeSefazCondutor Class Doc Comment
 *
 * @category Class
 ...
 */
class MdfeSefazCondutor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MdfeSefazCondutor';
    ...
    */
     ...
     * Sets x_nome
     *
     * @param string $x_nome Nome do Condutor.
     *
     * @return self
     */
    public function setXNome($x_nome)
    {
        ...
        if (!is_null($x_nome) && (mb_strlen($x_nome) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling MdfeSefazCondutor., must be smaller than or equal to 60.');
        }
        if (!is_null($x_nome) && (mb_strlen($x_nome) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling MdfeSefazCondutor., must be bigger than or equal to 2.');
        }
     ...
     * Sets cpf
     *
     * @param string $cpf CPF do Condutor.
     *
     * @return self
     */
