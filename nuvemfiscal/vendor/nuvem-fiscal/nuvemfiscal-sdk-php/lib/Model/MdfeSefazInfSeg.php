...
/**
 * MdfeSefazInfSeg Class Doc Comment
 *
 * @category Class
 ...
 */
class MdfeSefazInfSeg implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MdfeSefazInfSeg';
    ...
    {
        $this->setIfExists('x_seg', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['x_seg'];
    }

    /**
     * Sets x_seg
     *
     * @param string $x_seg Nome da Seguradora.
     *
     * @return self
     */
    public function setXSeg($x_seg)
    {
        ...
        if (!is_null($x_seg) && (mb_strlen($x_seg) > 30)) {
            throw new \InvalidArgumentException('invalid length for $x_seg when calling MdfeSefazInfSeg., must be smaller than or equal to 30.');
        }
        if (!is_null($x_seg) && (mb_strlen($x_seg) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_seg when calling MdfeSefazInfSeg., must be bigger than or equal to 1.');
        }
     ...
     * Sets cnpj
     *
     * @param string $cnpj Número do CNPJ da seguradora.  Obrigatório apenas se responsável pelo seguro for (2) responsável pela contratação do transporte - pessoa jurídica.
     *
     * @return self
     */
