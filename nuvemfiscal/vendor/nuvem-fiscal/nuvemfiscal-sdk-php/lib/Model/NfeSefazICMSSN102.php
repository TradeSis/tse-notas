...
/**
 * NfeSefazICMSSN102 Class Doc Comment
 *
 * @category Class
 ...
 */
class NfeSefazICMSSN102 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfeSefazICMSSN102';
    ...
    */
     ...
     * Sets csosn
     *
     * @param string $csosn * 102 - Tributada pelo Simples Nacional sem permissão de crédito  * 103 - Isenção do ICMS  no Simples Nacional para faixa de receita bruta  * 300 - Imune  * 400 - Não tributda pelo Simples Nacional (v.2.0) (v.2.0)
     *
     * @return self
     */
