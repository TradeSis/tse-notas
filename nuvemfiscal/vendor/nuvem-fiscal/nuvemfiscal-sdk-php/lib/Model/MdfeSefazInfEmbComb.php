...
/**
 * MdfeSefazInfEmbComb Class Doc Comment
 *
 * @category Class
 ...
 */
class MdfeSefazInfEmbComb implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MdfeSefazInfEmbComb';
    ...
    {
        $this->setIfExists('c_emb_comb', $data ?? [], null);
        $this->setIfExists('x_balsa', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string
     */
    public function getCEmbComb()
    {
        return $this->container['c_emb_comb'];
    }

    /**
     * Sets c_emb_comb
     *
     * @param string $c_emb_comb Código da embarcação do comboio.
     *
     * @return self
     */
     ...
     * @return string
     */
    public function getXBalsa()
    {
        return $this->container['x_balsa'];
    }

    /**
     * Sets x_balsa
     *
     * @param string $x_balsa Identificador da Balsa.
     *
     * @return self
     */
