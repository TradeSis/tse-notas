...
/**
 * CtePedidoEmissao Class Doc Comment
 *
 * @category Class
 * @package  NuvemFiscal
 * @author   OpenAPI Generator team
 ...
 */
class CtePedidoEmissao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CtePedidoEmissao';
    ...
    protected static $openAPITypes = [
        'inf_cte' => '\NuvemFiscal\Model\CteSefazInfCte',
        'inf_cte_supl' => '\NuvemFiscal\Model\CteSefazInfCTeSupl',
        'ambiente' => 'string',
        'referencia' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('inf_cte_supl', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['inf_cte'] === null) {
            $invalidProperties[] = "'inf_cte' can't be null";
        }
     ...
     * Gets inf_cte
     *
     * @return \NuvemFiscal\Model\CteSefazInfCte
     */
     ...
     * Sets inf_cte
     *
     * @param \NuvemFiscal\Model\CteSefazInfCte $inf_cte inf_cte
     *
     * @return self
     */
     ...
     * Gets inf_cte_supl
     *
     * @return \NuvemFiscal\Model\CteSefazInfCTeSupl|null
     */
    public function getInfCteSupl()
    {
        return $this->container['inf_cte_supl'];
    }

    /**
     * Sets inf_cte_supl
     *
     * @param \NuvemFiscal\Model\CteSefazInfCTeSupl|null $inf_cte_supl inf_cte_supl
     *
     * @return self
     */
    public function setInfCteSupl($inf_cte_supl)
    {
        if (is_null($inf_cte_supl)) {
            throw new \InvalidArgumentException('non-nullable inf_cte_supl cannot be null');
        }
        $this->container['inf_cte_supl'] = $inf_cte_supl;
