...
/**
 * NfeSefazICMS70 Class Doc Comment
 *
 * @category Class
 * @description Tributação pelo ICMS  * 70 - Com redução de base de cálculo e cobrança do ICMS por substituição tributária
 * @package  NuvemFiscal
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NfeSefazICMS70 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfeSefazICMS70';
    ...
    */
     ...
     * Sets cst
     *
     * @param string $cst Tributção pelo ICMS  * 70 - Com redução de base de cálculo e cobrança do ICMS por substituição tributária
     *
     * @return self
     */
     ...
     * Sets p_red_bc
     *
     * @param float $p_red_bc Percentual de redução da BC.
     *
     * @return self
     */
     ...
     * Sets v_bcfcpst
     *
     * @param float|null $v_bcfcpst Valor da Base de cálculo do FCP retido por substituição tributária.
     *
     * @return self
     */
