...
/**
 * EmpresaPedidoCadastroCertificado Class Doc Comment
 *
 * @category Class
 * @package  NuvemFiscal
 * @author   OpenAPI Generator team
 ...
 */
class EmpresaPedidoCadastroCertificado implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmpresaPedidoCadastroCertificado';
    ...
    {
        $this->setIfExists('certificado', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['certificado'];
    }
    ...
    public function setCertificado($certificado)
    {
        if (is_null($certificado)) {
            throw new \InvalidArgumentException('non-nullable certificado cannot be null');
        }
        ...
        $this->container['certificado'] = $certificado;
