 ...
 */
class CteSefazNatCarga implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSefazNatCarga';
    ...
    {
        $this->setIfExists('x_dime', $data ?? [], null);
        $this->setIfExists('c_inf_manu', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getXDime()
    {
        return $this->container['x_dime'];
    }

    /**
     * Sets x_dime
     *
     * @param string|null $x_dime Dimensão.  Formato:1234X1234X1234 (cm). Esse campo deve sempre que possível ser preenchido. Entretanto, quando for impossível o preenchimento das dimensões, fica obrigatório o preenchimento da cubagem em metro cúbico do leiaute do CT-e da estrutura genérica (infQ).
     *
     * @return self
     */
     ...
     * @return string[]|null
     */
    public function getCInfManu()
    {
        return $this->container['c_inf_manu'];
    }
     ...
     * @return self
     */
    public function setCInfManu($c_inf_manu)
    {
        if (is_null($c_inf_manu)) {
            throw new \InvalidArgumentException('non-nullable c_inf_manu cannot be null');
        }
        $this->container['c_inf_manu'] = $c_inf_manu;
