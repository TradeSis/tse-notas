 ...
 */
class EmpresaConfigNfceSefaz implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmpresaConfigNfceSefaz';
    ...
    {
        $this->setIfExists('id_csc', $data ?? [], null);
    ...
    */
     ...
     * @return self
     */
    public function setIdCsc($id_csc)
    {
        if (is_null($id_csc)) {
            throw new \InvalidArgumentException('non-nullable id_csc cannot be null');
        }
        $this->container['id_csc'] = $id_csc;
