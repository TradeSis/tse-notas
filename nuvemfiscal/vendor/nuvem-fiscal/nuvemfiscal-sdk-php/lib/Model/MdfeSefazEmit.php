 ...
 */
class MdfeSefazEmit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MdfeSefazEmit';
    ...
    protected static $openAPITypes = [
        ...
        'x_nome' => 'string',
        'x_fant' => 'string',
        'ender_emit' => '\NuvemFiscal\Model\MdfeSefazEndeEmi'
    ];
    ...
    */
    ...
    public function setXNome($x_nome)
    {
        ...
        if (!is_null($x_nome) && (mb_strlen($x_nome) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling MdfeSefazEmit., must be smaller than or equal to 60.');
        }
        if (!is_null($x_nome) && (mb_strlen($x_nome) < 2)) {
            throw new \InvalidArgumentException('invalid length for $x_nome when calling MdfeSefazEmit., must be bigger than or equal to 2.');
        }
    ...
    public function setXFant($x_fant)
    {
        ...
        if (!is_null($x_fant) && (mb_strlen($x_fant) > 60)) {
            throw new \InvalidArgumentException('invalid length for $x_fant when calling MdfeSefazEmit., must be smaller than or equal to 60.');
        }
        if (!is_null($x_fant) && (mb_strlen($x_fant) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_fant when calling MdfeSefazEmit., must be bigger than or equal to 1.');
        }
     ...
     * Gets ender_emit
     *
     * @return \NuvemFiscal\Model\MdfeSefazEndeEmi|null
     */
     ...
     * Sets ender_emit
     *
     * @param \NuvemFiscal\Model\MdfeSefazEndeEmi|null $ender_emit ender_emit
     *
     * @return self
     */
