 ...
 */
class CteSefazNoInter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSefazNoInter';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('h_ini', $data ?? [], null);
        $this->setIfExists('h_fim', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['h_ini'] === null) {
            $invalidProperties[] = "'h_ini' can't be null";
        }
        if ($this->container['h_fim'] === null) {
            $invalidProperties[] = "'h_fim' can't be null";
        }
    ...
    {
        return $this->container['h_ini'];
    }

    /**
     * Sets h_ini
     *
     * @param string $h_ini Hora inicial.  Formato HH:MM:SS.
     *
     * @return self
     */
    ...
    {
        return $this->container['h_fim'];
    }

    /**
     * Sets h_fim
     *
     * @param string $h_fim Hora final.  Formato HH:MM:SS.
     *
     * @return self
     */
