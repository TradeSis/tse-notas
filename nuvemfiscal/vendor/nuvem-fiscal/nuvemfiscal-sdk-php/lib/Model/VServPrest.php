 ...
 */
class VServPrest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VServPrest';
    ...
    {
        $this->setIfExists('v_receb', $data ?? [], null);
    ...
    */
     ...
     * @return float|null
     */
    public function getVReceb()
    {
        return $this->container['v_receb'];
    }

    /**
     * Sets v_receb
     *
     * @param float|null $v_receb Valor monetário recebido pelo intermediário do serviço (R$).
     *
     * @return self
     */
     ...
     * Sets v_serv
     *
     * @param float $v_serv Valor dos serviços em R$.
     *
     * @return self
     */
