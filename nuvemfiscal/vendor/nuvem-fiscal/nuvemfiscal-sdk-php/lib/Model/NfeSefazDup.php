 ...
 */
class NfeSefazDup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfeSefazDup';
    ...
    {
        $this->setIfExists('n_dup', $data ?? [], null);
        $this->setIfExists('d_venc', $data ?? [], null);
        $this->setIfExists('v_dup', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['n_dup'];
    }

    /**
     * Sets n_dup
     *
     * @param string|null $n_dup Número da duplicata.
     *
     * @return self
     */
    public function setNDup($n_dup)
    {
        ...
        if (!is_null($n_dup) && (mb_strlen($n_dup) > 60)) {
            throw new \InvalidArgumentException('invalid length for $n_dup when calling NfeSefazDup., must be smaller than or equal to 60.');
        }
        if (!is_null($n_dup) && (mb_strlen($n_dup) < 1)) {
            throw new \InvalidArgumentException('invalid length for $n_dup when calling NfeSefazDup., must be bigger than or equal to 1.');
        }
     ...
     * Sets d_venc
     *
     * @param \DateTime|null $d_venc Data de vencimento da duplicata (AAAA-MM-DD).
     *
     * @return self
     */
    ...
    {
        return $this->container['v_dup'];
    }

    /**
     * Sets v_dup
     *
     * @param float $v_dup Valor da duplicata.
     *
     * @return self
     */
