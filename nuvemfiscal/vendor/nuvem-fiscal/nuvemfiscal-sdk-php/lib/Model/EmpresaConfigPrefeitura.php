 ...
 */
class EmpresaConfigPrefeitura implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmpresaConfigPrefeitura';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('senha', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($senha)) {
            throw new \InvalidArgumentException('non-nullable senha cannot be null');
        }
