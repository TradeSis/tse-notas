 ...
 */
class CteSefazInfDoc implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CteSefazInfDoc';
    ...
    */
     ...
     * Gets inf_nf
     *
     * @return \NuvemFiscal\Model\CteSefazInfNF[]|null
     */
    public function getInfNf()
    {
        return $this->container['inf_nf'];
    }
     ...
     * @return self
     */
    public function setInfNf($inf_nf)
    {
        if (is_null($inf_nf)) {
            throw new \InvalidArgumentException('non-nullable inf_nf cannot be null');
        }
        $this->container['inf_nf'] = $inf_nf;
     ...
     * Gets inf_nfe
     *
     * @return \NuvemFiscal\Model\CteSefazInfNFe[]|null
     */
     ...
     * Gets inf_outros
     *
     * @return \NuvemFiscal\Model\CteSefazInfOutros[]|null
     */
    public function getInfOutros()
    {
        return $this->container['inf_outros'];
    }
     ...
     * @return self
     */
    public function setInfOutros($inf_outros)
    {
        if (is_null($inf_outros)) {
