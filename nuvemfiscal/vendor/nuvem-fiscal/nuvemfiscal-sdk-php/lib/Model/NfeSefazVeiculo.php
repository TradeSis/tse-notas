 ...
 */
class NfeSefazVeiculo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfeSefazVeiculo';
    ...
    */
     ...
     * Sets placa
     *
     * @param string $placa Placa do veículo (NT2011/004).
     *
     * @return self
     */
     ...
     * Sets rntc
     *
     * @param string|null $rntc Registro Nacional de Transportador de Carga (ANTT).
     *
     * @return self
     */
