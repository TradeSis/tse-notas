...
/**
 * NfeSefazDetExport Class Doc Comment
 *
 * @category Class
 ...
 */
class NfeSefazDetExport implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NfeSefazDetExport';
    ...
    protected static $openAPITypes = [
        'n_draw' => 'string',
        'export_ind' => '\NuvemFiscal\Model\NfeSefazExportInd'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('export_ind', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets export_ind
     *
     * @return \NuvemFiscal\Model\NfeSefazExportInd|null
     */
    public function getExportInd()
    {
        return $this->container['export_ind'];
    }

    /**
     * Sets export_ind
     *
     * @param \NuvemFiscal\Model\NfeSefazExportInd|null $export_ind export_ind
     *
     * @return self
     */
    public function setExportInd($export_ind)
    {
        if (is_null($export_ind)) {
            throw new \InvalidArgumentException('non-nullable export_ind cannot be null');
        }
        $this->container['export_ind'] = $export_ind;
